...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && $elm$core$Maybe$isJust(options.a7))
		{
			lang = options.a7.a;
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {am: fragment, aq: host, ax: path, az: port_, aG: protocol, aH: query};
	});
...
var $author$project$Main$Html = 0;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a0: false, a2: r.a2, aj: r.aj, an: r.an, bi: r.bi, bz: r.bz, aU: r.aU, aW: r.aW}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{a2: $elm$http$Http$emptyBody, aj: r.aj, an: _List_Nil, bi: 'GET', bz: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aW: r.aW});
};
var $elm$json$Json$Decode$map6 = _Json_map6;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$fetchPosts = function () {
	var fileTypeDecoder = A2(
		...
		function (s) {
			switch (s) {
				...
				default:
					return $elm$json$Json$Decode$fail('\'' + (s + '\' is not a valid file type, should be either \'html\' or \'markdown\''));
			}
		},
		$elm$json$Json$Decode$string);
	var decoder = $elm$json$Json$Decode$array(
		A7(
			...
			A2($elm$json$Json$Decode$field, 'excerpt', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'fileType', fileTypeDecoder)));
	return $elm$http$Http$get(
		{
			aj: A2($elm$http$Http$expectJson, $author$project$Main$GotPosts, decoder),
			aW: 'posts.json'
		});
}();
...
var $author$project$Main$BadRoute = {$: 2};
...
var $author$project$Main$parseUrl = function (url) {
	...
	if (!_v0.$) {
		if (!_v0.a.$) {
			var slug = _v0.a.a;
			return $author$project$Main$PostPage(slug);
		} else {
			var _v1 = _v0.a;
		...
		return function (_v1) {
			...
			return _Utils_Tuple2(
				...
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[cmd, $author$project$Main$fetchPosts])));
		}(
			A2(
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {be: index, bh: match, bl: number, bw: submatches};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ad: col, a6: contextStack, aD: problem, aN: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aN, s.ad, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{ad: 1, c: s.c, d: s.d, b: s.b + 1, aN: s.aN + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{ad: s.ad + 1, c: s.c, d: s.d, b: newOffset, aN: s.aN, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ad: col, c: s0.c, d: s0.d, b: offset, aN: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aN, s.ad, s);
	};
};
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.aN, s.ad, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{ad: newCol, c: s.c, d: s.d, b: newOffset, aN: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aN, s.ad, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {ad: s.ad + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, aN: s.aN, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aN, s.ad - (floatOffset + s.b), invalid, s.c));
		} else {
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				as: $elm$core$Result$Ok($elm$core$Basics$identity),
				bg: invalid,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ad: col, aD: problem, aN: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aN, p.ad, p.aD);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ad: 1, c: _List_Nil, d: 1, b: 0, aN: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	if (!postContent.z.T) {
		...
		if (!_v1.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Failed to parse markdown content')
					]));
		}
	}
};
var $author$project$Main$viewPostPage = function (model) {
	...
	if (!_v0.$) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('No post selected')
				]));
	}
};
				...
				switch (_v0.$) {
					case 0:
						...
						switch (_v1.$) {
							case 1:
								var posts = _v1.a;
								return $author$project$Main$viewHomePage(posts);
							case 0:
								return A2(
									$elm$html$Html$div,
									_List_fromArray(
							...
							default:
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Failed to load posts')
										]));
						}
					case 1:
						var slug = _v0.a;
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		bm: $author$project$Main$UrlChanged,
		bn: $author$project$Main$LinkClicked,
		bx: function (_v0) {
